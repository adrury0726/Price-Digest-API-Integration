...
//This class is controlling all of our logging for us in our SQL tables. We'll be calling the callLogging.logError class/method in order to do the logging.

namespace PriceDigestAPI.Classes
{
    public interface ILogging
    {
        long? startCall(int subscriberId, int applicationNum, int userNum, string callType);
    ...
    public class DummyCallLogging : ILogging
    {
        ...
        public long? startCall(int subscriberId, int applicationNum, int userNum, string callType) { return -1; }
    }
    public class CallLogging : ILogging
    {
        ...
        public long? startCall(int subscriberId, int applicationNum, int userNum, string callType)
        {
            long? callId;
