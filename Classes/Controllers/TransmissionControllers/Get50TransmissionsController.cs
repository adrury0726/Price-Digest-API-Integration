...
{
    [Route("Post50Transmissions")]
    [ApiController]
    public class Get50TransmissionsController : ControllerBase
    {
        [HttpPost(Name = "Post50Transmissions")]
        public IActionResult Post([FromServices] IAPICalls apiCalls, [FromServices] ILogging callLogging, [FromServices] IDBConnection dBConnection, AppBody appBody)
        {
            ...
            try
            {
                ...
                userNum = 0;
                string callType = "Get50TransmissionsController Class"; //Used to let devs know exactly where errors are occurring.
                ...
                string endpoint = "values/options?sizeClassId=" + components.SizeClassID + "&year=" + components.ModelYear + "&optionFamily=Transmission&offset=50";
